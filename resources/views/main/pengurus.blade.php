        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="row gx-3 gy-2 align-items-center">
                    <div class="col-md-3">
                        <label class="form-label" for="basic-default-password12">Cari Pengurus</label>
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#destroy-{{ $user->id }}"><i
                                                    class="bx bx-trash me-1"></i>Hapus Pengurus</a>
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel3">Tambah Pengurus</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form action="{{ url('register-user-pengurus/update/' . $user->id) }}"
                                ...
                                <div class="modal fade" id="editModalPassword-{{ $user->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form
                                                    action="{{ url('register-user-pengurus/update-password/' . $user->id) }}"
                                                    class="demo-vertical-spacing demo-only-element" method="POST"
                                                    autocomplete="off">
                                                    @csrf
                                                    <div class="mt-2">
                                ...
                                <div class="modal fade" id="destroy-{{ $user->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ url('register-user-pengurus/delete/' . $user->id) }}"
                                                    class="demo-vertical-spacing demo-only-element" method="POST"
                                                    autocomplete="off">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="mt-2">
                                                        <label for="basic-default-password12">Apakah anda yakin ingin
                                                            menghapus data pengurus <br> nama:
        ...
        <div class="modal fade" id="largeModalExportExel" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="register-user-pengurus/check/excel" class="demo-vertical-spacing demo-only-element"
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="submit" id="btn_save_add_import"
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="register-user-pengurus/check" class="demo-vertical-spacing demo-only-element"
