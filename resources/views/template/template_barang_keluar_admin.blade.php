...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="assets/assets/" >
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />
    
    <title>PT. Sinar Sahabat Indonesia</title>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <ul class="menu-inner py-1">
                <!-- Components -->
                <li class="menu-header small text-uppercase"><span class="menu-header-text">Daftar List</span></li>
                <li class="menu-item">
                    <a href="toko-admin" class="menu-link">
                ...
                <li class="menu-item">
                    <a href="barang-admin" class="menu-link">
                ...
                <!-- Components -->
                <li class="menu-header small text-uppercase"><span class="menu-header-text">Semua Transaksi</span></li>
                
                <li class="menu-item">
                    <a href="product-in-admin" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-archive-in"></i>
                        <div data-i18n="Analytics">Barang Masuk</div>
                    </a>
                </li>
                <li class="menu-item active">
                    <a href="product-out-admin" class="menu-link">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                @include('main.barang_keluar_admin')
                ...
                <footer class="content-footer footer bg-footer-theme">
                    <div class="d-flex justify-content-center">
                        ...
                        , made with ❤️ by
                        <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder" style="pointer-events: none; cursor: default">ThemeSelection</a>
                    </div>
                </footer>
                <!-- / Footer -->
