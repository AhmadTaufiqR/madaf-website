        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Components -->
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Semua Transaksi</span>
                    </li>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    @include('main.barang_masuk_admin')
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder"
                                style="pointer-events: none; cursor: default">ThemeSelection</a>
                        </div>
                    </footer>
                    <!-- / Footer -->
